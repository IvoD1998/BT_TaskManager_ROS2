...
public:
    ...
    */
    explicit MoveRobotTfActionServer(const std::shared_ptr<rclcpp::Node> node);

    /**
     * @brief Destructor of the action server
    */
    ~MoveRobotTfActionServer()
    {
        move_group_->stop();
    }
private:
    ...
    */
    ...
    void execute_move(const std::shared_ptr<const intervention_msgs::action::MoveRobotTf_Goal> goal,
