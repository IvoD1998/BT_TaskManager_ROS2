...
#include "intervention_msgs/action/move_robot_joint_state.hpp"
//Logging
#include "interventions/logger.hpp"
//Moveit
#include "moveit/move_group_interface/move_group_interface.h"

class MoveRobotJointStateActionServer
{
public:
    using MoveAction = intervention_msgs::action::MoveRobotJointState;
    ...
    */
    explicit MoveRobotJointStateActionServer(const std::shared_ptr<rclcpp::Node> node);
    
    /**
     * @brief Destructor of the action server
    */
    ~MoveRobotJointStateActionServer()
    {
        move_group_->stop();
    }
private:
    ...
    */
    ...
    void execute_move(const std::shared_ptr<const intervention_msgs::action::MoveRobotJointState_Goal> goal,
