...
class InitMoveRobot : public BT::StatefulActionNode
{
public: 
    ...
    */
    InitMoveRobot(const std::string &name, const BT::NodeConfig &config) : StatefulActionNode(name, config)
    {
        initRos();
    } 
    ...
    */   
    ...
    {
        return{BT::InputPort<sensor_msgs::msg::JointState>("initJointState"),
...
private:
    ...
    */
    ...
    sensor_msgs::msg::JointState initJointState;
